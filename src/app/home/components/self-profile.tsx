...
<div
    ...
    <div className="mx-auto w-20 h-20 relative border-4 border-white rounded-full overflow-hidden">
        <Image width={100}  height={100}  className="object-cover object-center h-20 border-indigo-100" src='https://randomuser.me/api/portraits/men/69.jpg' alt='Woman looking front'/>
    </div>
