    ...
    <>
      {isModalOpen && (
        <div className="fixed inset-0 z-[99] flex items-center justify-center bg-gray-800 bg-opacity-50">
          <div className="bg-white shadow-[0px_0px_16px_0px_rgba(0,_0,_0,_0.1)] flex flex-col py-5 rounded-lg w-[90vw] md:w-[60vw] lg:w-[40vw] max-h-[90vh] overflow-y-auto">
                ...
                <div key={id} className="space-y-2">
                  ...
                  {opt.input === "textarea" && (
                    <textarea
                      ...
                      onChange={(e) => handleInputChange(opt.key as keyof ProfileData, e.target.value)}
                  ...
                  {opt.input === "tags" && (
                    <div className="space-y-2">
                      <div className="flex flex-wrap gap-2">
                        {tempProfileData.skills !=undefined &&  tempProfileData.skills.length >0 &&
                  ...
                  {opt.input === "images" && (
                    <div>
                      <div className="grid grid-cols-3 gap-2 mb-2">
                        { tempProfileData.featuredPhotos !=undefined && tempProfileData.featuredPhotos.length>0 &&  tempProfileData.featuredPhotos.map((photo, index) => (
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          if (e.target.files) {
                            ...
                            handleInputChange(
                              "featuredPhotos",
                              [...tempProfileData.featuredPhotos, ...newPhotos]
                            );
                          }
                        }}
                        className="text-sm"
